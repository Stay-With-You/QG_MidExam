...
nings.filterwarnings('ignore')   #忽略警告
...
# 先验原理：
    # 如果一个项集是频繁的，它的所有子集也是频繁的！（反例很有用）


def loadDataSet():
    #读入文件
    dataSet = pd.read_csv('E:\\All_Test_Files\\Py_File\\data\\mushroom\\agaricus-lepiota.data', ',', header=None)
    #加上列名，便于操作
